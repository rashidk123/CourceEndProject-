...
<head>
    ...
    <style>
        ...
        .card img {
            ...
            height: 80px;
            object-fit: cover;
            border-radius: 10px; /* square thumbnail with soft corners */
            margin-bottom: 15px;
        }
        .card h3 {
            margin: 0 0 10px;
